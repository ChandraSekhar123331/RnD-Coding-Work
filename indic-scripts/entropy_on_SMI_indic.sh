...
echo
echo Creating directory $results_prefix_path/entropy/
echo
mkdir -p $results_prefix_path/entropy/
...
echo entropy-budget is $entropy_budget
...
--selection_count=$entropy_budget
